...
-- 1. Try C-Level Method Hook (Highly robust, captures index calls)
    ...
    pcall(function()
        ...
        oldFireServer = hookfunction(Instance.new("RemoteEvent").FireServer, newcclosure(function(self, ...)
            if not checkcaller() then
                ...
                pcall(function()
                    print("[AJIZ HOOK FIRE] Remote: " .. self.Name .. " | Key: " .. firstArg .. " | Args: " .. safeDump(args))
                end)
        ...
        oldInvokeServer = hookfunction(Instance.new("RemoteFunction").InvokeServer, newcclosure(function(self, ...)
            if not checkcaller() then
                ...
                pcall(function()
                    print("[AJIZ HOOK INVOKE] Remote: " .. self.Name .. " | Key: " .. firstArg .. " | Args: " .. safeDump(args))
                end)
...
-- 2. Fallback to Metamethod Namecall Hook if C-Level Hook failed/unsupported
