--[[
    ========================================================================
    ⚡ AJIZ HUB - SABER SIMULATOR (MODULAR GAME LOGIC) ⚡
    ========================================================================
--]]
...
-- 4. Auto Rebirth Worker (Collects Crowns automatically)
task.spawn(function()
    while true do
        task.wait(1.0)
...
Panel:AddToggle("Auto Swing Saber", false, function(state)
    _G.AutoSwing = state
end)

Panel:AddToggle("Auto Sell Strength", false, function(state)
    _G.AutoSell = state
end)

Panel:AddToggle("Auto Buy Sabers", false, function(state)
    _G.AutoBuySabers = state
end)

Panel:AddToggle("Auto Buy DNA", false, function(state)
    _G.AutoBuyDNA = state
end)
...
AjizLib:Notify("Ajiz Hub", "Saber Simulator Script Loaded!", 3)
