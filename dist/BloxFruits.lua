--[[
    ========================================================================
    🔥 AJIZ HUB - BLOX FRUITS (FULL LOGICAL ENGINE & TELEPORT FLYOUT) 🔥
    ========================================================================
    • 100% Working Logic: Auto Level, Auto Quest, Fast Attack, Bring Mobs, Buso Haki
    • Interactive Teleport Sub-Menu: Click "Teleport" to open Islands List
    • Safe Movement: Noclip + BodyVelocity + Safe Float to prevent falling / void death
    • Delta Mobile Optimized: Native touch support, gethui/PlayerGui container
    • Unobfuscated & Clean: Instant loading on all executors
    ========================================================================
--]]
...
-- ========================================================================
-- 🎨 GUI INTERFACE WITH TELEPORT FLYOUT
-- ========================================================================
...
TitleLabel.Text = "+ AJIZ HUB - BLOX FRUITS"
...
-- ========================================================================
-- 📍 TELEPORT FLYOUT SUB-MENU (SIDE PANEL)
-- ========================================================================
local TeleportFlyout = Instance.new("Frame")
...
-- Teleport Button (Opens Islands Flyout)
local function AddTeleportButton()
    local ItemBtn = Instance.new("TextButton")
    ItemBtn.Name = "Teleport_Item"
    ItemBtn.Size = UDim2.new(1, 0, 0, 32)
    ItemBtn.BackgroundColor3 = Theme.ItemBg
    ItemBtn.BorderSizePixel = 0
    ItemBtn.AutoButtonColor = false
...
-- ========================================================================
-- 📌 REGISTER CHECKBOX FEATURES
-- ========================================================================
AddToggle("Auto Level", false, function(state)
    _G.AutoLevel = state
    if state then
        _G.AutoQuest = true
        _G.FastAttack = true
...
AddToggle("Auto Quest", false, function(state)
    _G.AutoQuest = state
end)

AddToggle("Fast Attack", false, function(state)
    _G.FastAttack = state
end)

AddToggle("Bring Mobs (Magnet)", false, function(state)
    _G.BringMobs = state
end)

AddToggle("Auto Buso Haki", false, function(state)
    _G.AutoBuso = state
end)

-- Teleport Feature (Opens Sub-Menu)
AddTeleportButton()
